...
namespace OutlookGoogleCalendarSync {
    ...
    internal sealed class Program {
        ...
        private static void checkForZip(object sender, DoWorkEventArgs e) {
            ...
            string html = "";
            try {
                html = new System.Net.WebClient().DownloadString("https://github.com/EduShareGeorgian/OutlookGoogleSync/wiki/Latest-Releases");
            } catch (Exception ex) {
        ...
        public static void isNewVersion() {
            ...
            if (settingsVersion != Application.ProductVersion) {
                ...
                System.Diagnostics.Process.Start("https://github.com/EduShareGeorgian/OutlookGoogleSync/wiki/Release-Notes");
            }
        }
        #endregion
    }
